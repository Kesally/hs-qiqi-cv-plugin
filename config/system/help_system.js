...
export const helpList = [{
  ...
  {
    "icon": 35,
    "title": "拉黑词", "desc": "发送拉黑词帮助"
  },
  {
    "icon": 5,
    "title": "(开启|关闭)本群随机图", "desc": "开启或关闭本群的随机图片功能"
  },
  {
    "icon": 3,
    "title": "枫叶小姐姐视频|枫叶漫剪视频", "desc": "新的涩涩功能"
  },
  {
    "icon": 8,
    "title": "切换ai", "desc": "选择小爱 openai 青客云作为您的群聊ai"
  },
  {
    "icon": 16,
...
"group": "娱乐类",
  ...
  {
    "icon": 23,
    "title": "爱坤图片列表", "desc": "本地源坤坤图片初始150张可自己上传"
  }, 
  {
    "icon": 12,
...
"group": "管理员功能",
  ...
  {
    "icon":38,
    "title":"#卸载枫叶","desc":"一键卸载枫叶插件，让报错跟您说拜拜"
  }
  ]
